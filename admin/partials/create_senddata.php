...
$senddata = array(
    ...
    "sender_city_id"          => $sender_city_uuid,

    // Відправник (юридична особа або ФОП).
    "sender_company"          => $_POST['invoice_sender_name'],

    // ПІБ контактної особи Відправника.
    ...
    "sender_branch"           => $sender_warehouse_branch_arr[0],

    // ПІБ Одержувача
    "receiver"                => $_POST['invoice_recipient_name'],

    // ПІБ контакту Одержувача (допускається пусте значення, якщо Одержувач = контакт).
